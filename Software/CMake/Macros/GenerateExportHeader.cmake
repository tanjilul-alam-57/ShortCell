...
macro(make_export_header projectpath filename)
   file(GENERATE OUTPUT "${CMAKE_CURRENT_BINARY_DIR}/Export/${projectpath}/${filename}" CONTENT "#pragma once\n#include \"${CMAKE_CURRENT_SOURCE_DIR}/${filename}\"\n")
endmacro()
...
macro(_DO_SET_MACRO_VALUES TARGET_LIBRARY)
  ...
  set(DEFINE_STATIC_EXPORT)
  set(DEFINE_STATIC_IMPORT)
  ...
  if(NOT ${type} STREQUAL "STATIC_LIBRARY")
    if(WIN32)
      ...
      set(DEFINE_STATIC_IMPORT "extern")
...
macro(_DO_GENERATE_EXPORT_HEADER TARGET_LIBRARY)
  ...
  set(oneValueArgs PREFIX_NAME BASE_NAME EXPORT_MACRO_NAME EXPORT_EXTERN_NAME EXPORT_FILE_NAME
  ...
  set(EXPORT_STATIC_NAME "${_GEH_PREFIX_NAME}${BASE_NAME_UPPER}_EXTERN")
  ...
  if(_GEH_EXPORT_EXTERN_NAME)
    set(EXPORT_STATIC_NAME ${_GEH_PREFIX_NAME}${_GEH_EXPORT_EXTERN_NAME})
  endif()
